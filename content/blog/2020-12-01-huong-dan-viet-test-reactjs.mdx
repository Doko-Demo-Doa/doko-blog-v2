...
![reddit](https://i.ibb.co/k3cNwmk/react-testing-intro-2.gif)
...
Repo code đầy đủ nằm ở [đây](https://git.acaziasoft.com/acazia/beginners-guide-to-testing-react). Các bạn có thể clone về để xem cùng bài hướng dẫn này.
...
![debug element](https://i.ibb.co/17KvVTP/image.png)
...
![link navigation](https://i.ibb.co/Bw77Xg1/react-testing-intro-link.gif)
